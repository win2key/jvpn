...
func main() {
	vpnLogin, vpnPassword, vpnServer, jProxy := checkEnvironmentVariables()
...
func checkEnvironmentVariables() (string, string, string, string) {
	requiredEnvVars := []string{"VPN_LOGIN", "VPN_PASSWORD", "VPN_SERVER", "JPROXY"}
	...
	return vpnLogin, vpnPassword, vpnServer, jProxy
}
